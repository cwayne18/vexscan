...
| `--images-from` | | Scan every image named in this list — a file with one reference per line, a URL, or `-` for stdin. `#` comments allowed, repeats scanned once — see [Scanning a fleet](#scanning-a-fleet---images-from) |
